...
const RainAreasView: React.FC<Props> = ({ syncTimestamp }) => {
  ...
  const radarTimestamp =
    history.length > 0 ? history[history.length - 1].date.toISOString() : syncTimestamp
  ...
  const baseMapStyle =
    theme === 'latte'
      ...
      : {
        ...
        } // Dark theme: Light lines on dark bg

  const radarLayerStyle =
    theme === 'latte'
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 animate-fadeIn">
        ...
        <header className="flex justify-between items-start gap-2">
          <div className="flex flex-col gap-1 pr-2">
            <div className="flex items-center gap-3">
              ...
              <div className="mt-1">
                <span className="bg-blue text-xs font-semibold px-2 py-0.5 md:py-1 rounded text-mantle">
                  Live
                </span>
              </div>
            </div>
      ...
      <div className="relative max-w-4xl -mx-4 sm:mx-auto w-auto sm:w-full group">
        <div className="glass rounded-none sm:rounded-3xl overflow-hidden relative aspect-[853/562] bg-base border-y sm:border border-surface1/20 shadow-md transition-colors duration-500">
          <div
      ...
      <div className="bg-surface0/60 p-5 md:p-6 rounded-2xl border border-surface1/20 mt-2 max-w-4xl mx-auto w-full">
        <div className="flex items-center gap-5 md:gap-8">
          <button
            onClick={() => setIsPlaying(!isPlaying)}
            className={`w-12 h-12 md:w-14 md:h-14 flex items-center justify-center rounded-full transition-colors shrink-0 ${
              isPlaying ? 'bg-blue/20 text-blue border border-blue/30' : 'bg-blue text-mantle'
            }`}
          >
            ...
            <div className="relative flex items-center h-4">
              ...
              <input
                ...
                className="relative w-full h-4 bg-transparent appearance-none cursor-pointer accent-blue z-10 
                  ...
                  [&::-webkit-slider-thumb]:border-[3px] [&::-webkit-slider-thumb]:border-mantle"
              />
            </div>
          </div>
        </div>
      ...
      <div className="mt-4 mb-2 max-w-4xl mx-auto w-full px-2">
        ...
        <div className="relative p-[1px] bg-surface0/5 rounded-sm">
